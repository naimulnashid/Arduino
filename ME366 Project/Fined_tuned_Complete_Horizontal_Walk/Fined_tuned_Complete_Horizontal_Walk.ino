...
{
      front.setPWM(lshoulder, 0, getPWM(90));
      front.setPWM(larm, 0, getPWM(94));
      front.setPWM(lhand, 0, getPWM(162)); //TESTING
      back.setPWM(lshoulder, 0, getPWM(90));
      back.setPWM(larm, 0, getPWM(85));
      back.setPWM(lhand, 0, getPWM(92));

      front.setPWM(rshoulder, 0, getPWM(90));
      front.setPWM(rarm, 0, getPWM(80));
      front.setPWM(rhand, 0, getPWM(110)); //TESTING
      back.setPWM(rshoulder, 0, getPWM(90));
      back.setPWM(rarm, 0, getPWM(100));
      back.setPWM(rhand, 0, getPWM(80));
}
